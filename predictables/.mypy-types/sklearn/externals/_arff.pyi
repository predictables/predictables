...
class DenseGeneratorData:
    def decode_rows(self, stream, conversors) -> Generator[Any, None, None]: ...
    def encode_data(self, data, attributes) -> Generator[Any, None, None]: ...
...
class ArffEncoder:
    def encode(self, obj): ...
    def iter_encode(self, obj) -> Generator[Any, None, None]: ...
