...
from ._base import (
    LinearClassifierMixin as LinearClassifierMixin,
    SparseCoefMixin as SparseCoefMixin,
...
class _ValidationScoreCallback:
    ...
    def __init__(
        self, estimator, X_val, y_val, sample_weight_val, classes: Any | None = ...
    ) -> None: ...
