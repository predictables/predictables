...
#     nm = _get_x_name(x, x_name)

#     # Use the reverse-sorted date to calculate the rolling sum
#     lf = lf.with_columns(reversed_date_expr.alias("reversed_date"))
#     lf = lf.sort("reversed_date")
#     lf = lf.set_sorted("reversed_date")
#     lfg = lf.rolling("reversed_date", period=period, offset=offset, check_sorted=False)
#     lf = lfg.agg(pl.sum(x).alias(nm))
#     lf = (
#         lf.join(
#             lf_order,
#             how="left",
#             left_on="reversed_date",
#             right_on="date_reversed",
#             suffix="_right",
#         )
#         .collect()
#         .lazy()
#     )
#     print(f"lf columns: {lf.columns}")
#     print(f"from _rolling_sum_no_categories: {lf.collect()}")
#     return lf
#     # return (
#     #     lf.with_columns(reversed_date_expr.alias("reversed_date"))
#     #     .sort("reversed_date")
#     #     .set_sorted("reversed_date")
#     #     .rolling("reversed_date", period=period, offset=offset, check_sorted=False)
#     #     .agg(pl.sum(x).alias(nm))
#     #     .join(
#     #         lf_order,
#     #         how="left",
#     #         on="date",
