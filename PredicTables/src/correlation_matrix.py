...
from PredicTables.src._utils import _to_numpy, _to_pandas, _select_binary_columns



def _pearson_correlation_matrix(data: Union[pd.DataFrame,
                                            pl.DataFrame,
                                            pl.LazyFrame],
...
def _correlation_matrix(data: Union[pd.DataFrame,
                                            pl.DataFrame,
                                            pl.LazyFrame],
                                method: str = 'pearson') -> pd.DataFrame:
    """
...
def _correlation_matrix_plot(data: Union[pd.DataFrame,
                                   pd.Series,
                                   pl.DataFrame,
                                   pl.Series,
                                   pl.LazyFrame,
...
def _highly_correlated_variables(data: Union[pd.DataFrame,
                                             pd.Series,
                                             pl.DataFrame,
                                             pl.Series,
                                             pl.LazyFrame,
                                             ...
                                             list],
                                 method: str = 'pearson',
                                 threshold: float = 0.9) -> pl.LazyFrame:
    """
